...
public class CraftingStickGUIScreen extends AbstractContainerScreen<CraftingStickGUIMenu> {
	private final static HashMap<String, Object> guistate = CraftingStickGUIMenu.guistate;
