...
public class DedicatedStorageGUIScreen extends AbstractContainerScreen<DedicatedStorageGUIMenu> {
	private final static HashMap<String, Object> guistate = DedicatedStorageGUIMenu.guistate;
