...
public class EasySmelterGUIScreen extends AbstractContainerScreen<EasySmelterGUIMenu> {
	private final static HashMap<String, Object> guistate = EasySmelterGUIMenu.guistate;
