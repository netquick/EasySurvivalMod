...
public class EasyAnvilGUIScreen extends AbstractContainerScreen<EasyAnvilGUIMenu> {
	private final static HashMap<String, Object> guistate = EasyAnvilGUIMenu.guistate;
