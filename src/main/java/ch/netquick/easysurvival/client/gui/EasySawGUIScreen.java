...
public class EasySawGUIScreen extends AbstractContainerScreen<EasySawGUIMenu> {
	private final static HashMap<String, Object> guistate = EasySawGUIMenu.guistate;
