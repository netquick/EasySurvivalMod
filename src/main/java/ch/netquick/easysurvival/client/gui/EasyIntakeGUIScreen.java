...
public class EasyIntakeGUIScreen extends AbstractContainerScreen<EasyIntakeGUIMenu> {
	private final static HashMap<String, Object> guistate = EasyIntakeGUIMenu.guistate;
