...
public class TreeCropGUIScreen extends AbstractContainerScreen<TreeCropGUIMenu> {
	private final static HashMap<String, Object> guistate = TreeCropGUIMenu.guistate;
