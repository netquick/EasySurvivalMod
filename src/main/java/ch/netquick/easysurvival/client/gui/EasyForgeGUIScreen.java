...
public class EasyForgeGUIScreen extends AbstractContainerScreen<EasyForgeGUIMenu> {
	private final static HashMap<String, Object> guistate = EasyForgeGUIMenu.guistate;
