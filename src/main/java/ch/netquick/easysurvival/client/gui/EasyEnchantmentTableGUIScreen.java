...
public class EasyEnchantmentTableGUIScreen extends AbstractContainerScreen<EasyEnchantmentTableGUIMenu> {
	private final static HashMap<String, Object> guistate = EasyEnchantmentTableGUIMenu.guistate;
