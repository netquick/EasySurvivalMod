...
public class EasyConverterGUIScreen extends AbstractContainerScreen<EasyConverterGUIMenu> {
	private final static HashMap<String, Object> guistate = EasyConverterGUIMenu.guistate;
