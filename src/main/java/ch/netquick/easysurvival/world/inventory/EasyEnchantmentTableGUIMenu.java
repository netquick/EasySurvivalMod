...
import ch.netquick.easysurvival.network.EasyEnchantmentTableGUISlotMessage;
import ch.netquick.easysurvival.init.EasysurvivalModMenus;
import ch.netquick.easysurvival.EasysurvivalMod;

public class EasyEnchantmentTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EasyEnchantmentTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EasysurvivalModMenus.EASY_ENCHANTMENT_TABLE_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			EasysurvivalMod.PACKET_HANDLER.sendToServer(new EasyEnchantmentTableGUISlotMessage(slotid, x, y, z, ctype, meta));
			EasyEnchantmentTableGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
