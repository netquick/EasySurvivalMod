...
public class TreeCropGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TreeCropGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EasysurvivalModMenus.TREE_CROP_GUI.get(), id);
