...
public class EasyConverterGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EasyConverterGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EasysurvivalModMenus.EASY_CONVERTER_GUI.get(), id);
